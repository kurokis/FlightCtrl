...
void InitializeAdctrl(void){
  ...
  const float param_Ts = 1.0 / 128.0;
	...
	const float param_Hsigma1x_sos[5] = { 1, 1, 0, -0.928952473370368, 0};
	const float param_Hsigma1x_gain = 0.0355237633148160;
	...
	const float param_Hsigma2x_gain = 0.0193235094840418;
	...
	const float param_Hsigma3x_gain = 0.0775227714255438;

	InitializeL1(&l1x, param_Ts, param_Amx, param_Bmx, param_Bumx, param_Kgx,
		param_Hsigma1x_sos, param_Hsigma1x_gain,
		param_Hsigma2x_sos, param_Hsigma2x_gain,
		param_Hsigma3x_sos, param_Hsigma3x_gain);

	InitializeL1(&l1y, param_Ts, param_Amx, param_Bmx, param_Bumx, param_Kgx,
		param_Hsigma1x_sos, param_Hsigma1x_gain,
		param_Hsigma2x_sos, param_Hsigma2x_gain,
		param_Hsigma3x_sos, param_Hsigma3x_gain);

	//InitializeL1(&l1z, param_Ts, param_Amz, param_Bmz, param_Bumz, param_Kgz,
	//	param_Hsigma1z_sos, param_Hsigma1z_gain,
	//	param_Hsigma2z_sos, param_Hsigma2z_gain,
	//	param_Hsigma3z_sos, param_Hsigma3z_gain);

	//InitializeL1(&l1psi, param_Ts, param_Ampsi, param_Bmpsi, param_Bumpsi, param_Kgpsi,
	//	param_Hsigma1psi_sos, param_Hsigma1psi_gain,
	//	param_Hsigma2psi_sos, param_Hsigma2psi_gain,
	//	param_Hsigma3psi_sos, param_Hsigma3psi_gain);
}
